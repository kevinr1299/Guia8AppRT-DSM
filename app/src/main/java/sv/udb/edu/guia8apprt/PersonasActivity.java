    ...
    private void inicializar() {
        ...
        listaPersonas.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                intent.putExtra("born", personas.get(i).getBorn());
                intent.putExtra("sex", personas.get(i).getSex());
                intent.putExtra("weight", personas.get(i).getWeight());
                intent.putExtra("height", personas.get(i).getHeight());
